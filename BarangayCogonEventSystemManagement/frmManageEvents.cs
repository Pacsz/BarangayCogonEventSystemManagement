...
namespace BarangayCogonEventManagementSystem
{
    public partial class frmManageEvents : Form
    {
        ...
        {
            string query = "SELECT id, title, description, date, time, venue, type, organizer FROM events";
        ...
        private void btnAddEvent_Click(object sender, EventArgs e)
        {
            try
            {
                string query = @"INSERT INTO events (title, description, date, time, venue, type, organizer)
                                 VALUES (@title, @description, @date, @time, @venue, @type, @organizer)";
        ...
        private void dgvEvents_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            txtTitle.Text = dgvEvents.CurrentRow.Cells["title"].Value.ToString();
